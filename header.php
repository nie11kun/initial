...
<head>
    ...
    <title><?php $this->archiveTitle(array(
                                    ...
                                    if ($this->is('index') && $this->options->subTitle) : ?> - <?php $this->options->subTitle();
                                                                                                        endif; ?></title>
    ...
    <header id="header">
        <div class="container clearfix">
            <div class="site-name">
                ...
                <?php else : ?>
                    <h1>
                        <a id="logo" href="<?php $this->options->siteUrl(); ?>"><?php if ($this->options->customTitle) : $this->options->customTitle();
            ...
            <div id="nav">
                ...
                <ul class="nav-menu">
                    ...
                    <?php if (!empty($this->options->Navset) && in_array('ShowCategory', $this->options->Navset)) : if (in_array('AggCategory', $this->options->Navset)) : ?>
                            <li class="menu-parent"><a><?php if ($this->options->CategoryText) : $this->options->CategoryText();
                                                                                                                            else : ?>分类<?php endif; ?></a>
                                <ul>
                                    <?php
                                                                                                                                    endif;
                        ...
                        ?>
                            <li class="menu-parent"><a><?php if ($this->options->PageText) : $this->options->PageText();
                                                                                                                                        else : ?>其他<?php endif; ?></a>
                                <ul>
                                <?php
                                                                                                                                    endif;
